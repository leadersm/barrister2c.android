 ...
 * 填写债务人
 */
public class AddDebtUserFragment extends Fragment {
    ...
    String type = CreditDebtUser.TYPE_DEBT;
    ...
    public boolean prepared(){
        ...
        if(typeId == R.id.rb_type_user){
            ...
            if(TextUtils.isEmpty(nameEditable)){
                UIHelper.showToast(getContext(),"请填写债务人联系人");
                return false;
            }

            if(TextUtils.isEmpty(userPhoneEditable)){
                UIHelper.showToast(getContext(),"请填写债务人电话");
                return false;
            }

            if(TextUtils.isEmpty(idNumEditable)){
                UIHelper.showToast(getContext(),"请填写债务人身份证号码");
                return false;
            }
            ...
            if(TextUtils.isEmpty(companyEditable)){
                UIHelper.showToast(getContext(),"请填写债务人公司名称");
                return false;
            }

            if(TextUtils.isEmpty(companyPhoneEditable)){
                UIHelper.showToast(getContext(),"请填写债务人公司电话");
                return false;
            }

            if(TextUtils.isEmpty(companyNumEditable)){
                UIHelper.showToast(getContext(),"请填写债务人公司信用代码");
                return false;
            }
        ...
        if(TextUtils.isEmpty(addressEditable)){
            UIHelper.showToast(getContext(),"请填写债务人联系地址");
            return false;
        }
