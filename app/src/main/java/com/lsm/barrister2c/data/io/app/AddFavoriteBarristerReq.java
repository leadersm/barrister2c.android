 ...
 * 收藏律师接口
 ...
   备注：
 */
public class AddFavoriteBarristerReq extends Action {

    String id;//barrister id

    public AddFavoriteBarristerReq(Context context, String id) {
        super(context);
        this.id = id;
    ...
    public String getName() {
        return AddFavoriteBarristerReq.class.getSimpleName();
    }
